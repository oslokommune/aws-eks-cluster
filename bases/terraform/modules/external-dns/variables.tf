...
variable "domain_filter" {
  description = "The domain that the kubernetes cluster is limited to create DNS entries for"
  type        = string
}

variable "hosted_zone_id" {
  description = "The ID of the hosted zone managing the given domain"
  type        = string
}
